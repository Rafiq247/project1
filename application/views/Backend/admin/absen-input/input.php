 							...
 							<form class="form-horizontal" action="<?php echo base_url() . 'admin/edit-absensi' ?>" method="post" enctype="multipart/form-data">
 								<div class="modal-body">
 									<div class="form-group">
 										...
 										<div class="col-sm-12">
 											<input type="text" value="<?php echo $b['id_fingerprint']; ?>" name="id_fingerprint" class="form-control " readonly>
 										</div>
 										...
 										<div class="col-sm-12">
 											<input type="text" value="<?php echo $b['status']; ?>" name="status" class="form-control " readonly>
 										</div>
 										<label class="col-sm-12">KODE VERIFIKASI</label>
 										<div class="col-sm-12">
 											<input type="text" value="<?php echo $b['verification_code']; ?>" name="verification_code" class="form-control " readonly>
 										</div>
 										<div class="col-sm-12">
